...
function normalizeTransactionOptions(sequelize, options = import_object.EMPTY_OBJECT) {
  return {
    ...options,
...
function assertTransactionIsCompatibleWithOptions(transaction, options) {
  ...
  if (options.deferrable !== transaction.options.deferrable && !((_a = options.deferrable) == null ? void 0 : _a.isEqual(transaction.options.deferrable))) {
    throw new Error(
